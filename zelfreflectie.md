...
#### Stories toewijzen [X]
#### oppassen met setters [X]
#### Naamgeving packages met kleine letters [X]
#### Naamgeving methodes duidelijker maken bv Put en changes is teveel van het goedde + change in restaurantservice [ ]
#### als publishing dish wordt gescheduled moet er worden nagekeken of er al 10 published dishes zijn [X]