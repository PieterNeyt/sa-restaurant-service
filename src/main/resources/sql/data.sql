...
VALUES
    ...
    ('a1b2c3d4-e5f6-4a7b-8c9d-000000000002', 'FRIDAY', '17:00:00', '00:00:00'),
    ('a1b2c3d4-e5f6-4a7b-8c9d-000000000002', 'SATURDAY', '17:00:00', '00:00:00'),
...
INSERT INTO dish (id, restaurant_id, name, description, price, state)
VALUES
    ('55555555-5555-5555-5555-555555555555', 'a1b2c3d4-e5f6-4a7b-8c9d-000000000002', 'California Roll', 'Crab, avocado, cucumber', 12.00, 'PUBLISHED'),
    ('66666666-6666-6666-6666-666666666666', 'a1b2c3d4-e5f6-4a7b-8c9d-000000000002', 'Salmon Nigiri', 'Fresh salmon on rice', 8.50, 'PUBLISHED'),
    ('77777777-7777-7777-7777-777777777777', 'a1b2c3d4-e5f6-4a7b-8c9d-000000000002', 'Dragon Roll', 'Eel and avocado', 18.00, 'NOT_PUBLISHED'),
    ('88888888-8888-8888-8888-888888888888', 'a1b2c3d4-e5f6-4a7b-8c9d-000000000002', 'Tuna Sashimi', 'Fresh tuna slices', 22.00, 'TEMP_NOT_AVAILABLE');