-- Restaurants met embedded address velden
INSERT INTO restaurant (id, owner_id, type, name, email, logo, is_open, price_category,
                        address_street, address_street_number, address_city, address_postal_code, address_country)
VALUES
    ('a1b2c3d4-e5f6-4a7b-8c9d-000000000001',
     '11111111-1111-1111-1111-111111111111',
     'PIZZERIA',
     'La Dolce Vita',
     'contact@ladolcevita.it',
     'logo_dolce_vita.png',
     false,
     'NORMAL',
     'Via Roma',      -- address_street
     '42',            -- address_street_number
     'Rome',          -- address_city
     '00100',         -- address_postal_code
     'Italy'),        -- address_country
    ...
    ('a1b2c3d4-e5f6-4a7b-8c9d-000000000002',
     ...
     true,
     'EXPENSIVE',
     'Shibuya Street', -- address_street
     '15',             -- address_street_number
     'Tokyo',          -- address_city
     '150-0002',       -- address_postal_code
     'Japan');         -- address_country

-- Opening hours for La Dolce Vita
...
-- Opening hours for Sakura Sushi
INSERT INTO restaurant_opening_hours (restaurant_id, day_of_week, opening_time, closing_time)
VALUES
